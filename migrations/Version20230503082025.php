 ...
 */
final class Version20230503082025 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salon ADD CONSTRAINT FK_F268F417F917CCFC FOREIGN KEY (proprietaire_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_F268F417F917CCFC ON salon (proprietaire_id)');
    }
}
